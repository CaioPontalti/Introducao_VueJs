...
<script>
import Default from '../componentes/Default.vue'
...
export default {
  ...
  created() {
    ...
    this.$http.get('http://localhost:3000/categorias').then(response =>{
      ...
      this.categorias = response.body; //categorias é a variavel que declaramos no data e
                                       //fazemos o v-for nela
